...
Este artículo presupone que usted está familiarizado con Thymeleaf y Spring 4.
No profundizaremos en los detalles de Spring Mail; para obtener más información, 
consulte el 
[capítulo sobre correo electrónico en la documentación de Spring](http://docs.spring.io/spring/docs/4.3.x/spring-framework-reference/html/mail.html).
...
realidad en un archivo `@Configuration` diferente que extiende 
`WebMvcConfigurerAdapter` (y que no mostraremos aquí para centrarnos en el 
