...
Thymeleaf permite configurar _filtros de reescritura de URL_ en tu aplicación, 
llamando al método `response.encodeURL(...)` de la clase 
`javax.servlet.http.HttpServletResponse` de la API de Servlets para cada URL 
generada a partir de una plantilla de Thymeleaf.
